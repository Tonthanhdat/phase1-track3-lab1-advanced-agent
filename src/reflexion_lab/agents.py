...
from .mock_runtime import FAILURE_MODE_BY_QID, actor_answer, evaluator, reflector, LLMTracker
...
class BaseAgent:
    ...
    def run(self, example: QAExample) -> RunRecord:
        ...
        for attempt_id in range(1, self.max_attempts + 1):
            ...
            token_estimate = LLMTracker.total_tokens
            # TODO: Replace with actual latency measurement
            latency_ms = LLMTracker.total_latency
